...
class ContextBuilder:
    ...
    def _build_finance_context(self, include_transactions: bool = True) -> str:
        ...
        if previous:
            ...
            lines.append(f"  {'🟢' if prev_summary.get('balance', 0) >= 0 else '🔴'} Saldo: R$ {prev_summary.get('balance', 0):,.2f}")
        ...
        if include_transactions:
            ...
            if transactions:
                ...
                for t in transactions:
                    ...
                    lines.append(f"  {emoji} {t['date']} | R$ {t['amount']:,.2f} | {t['description']} | {t['category']}")
