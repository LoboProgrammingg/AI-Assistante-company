...
class ContactAgent:
    ...
    def _handle_schedule_message(
        self, message: str, intent_result: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _execute_broadcast(self, user_id: int, group_names: List[str], message: str, db) -> Dict[str, Any]:
        ...
        # Executar broadcast
        result = broadcast_service.send_broadcast(user_id=user_id, message=message, group_names=normalized_groups)
    ...
    def _handle_broadcast_confirmation(
        self, message: str, pending: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _create_multiple_contacts_response(
        self, contacts: List[Dict[str, Any]], db=None, user_id: int = None
    ) -> Dict[str, Any]:
