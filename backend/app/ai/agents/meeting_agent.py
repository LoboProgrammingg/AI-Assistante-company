...
class MeetingAgent(BaseAgent):
    ...
    def _handle_schedule(
        self, message: str, context: Dict[str, Any], current_time, conversation_history: str
    ) -> Dict[str, Any]:
        """Processa agendamento de reunião."""

        extraction_prompt = MeetingPrompts.get_schedule_extraction_prompt(
            conversation_history=conversation_history, current_time=current_time, message=message
        )
