...
class MeetingExecutor:
    ...
    def create(params: Dict, db: Any, user_id: int, user_name: str) -> ExecutionResult:
        ...
        try:
            ...
            return ExecutionResult(
                success=True, action_type="create_meeting", data=meeting_data, response_template=template
            )
    ...
    def list_all(params: Dict, db: Any, user_id: int, user_name: str) -> ExecutionResult:
        ...
        try:
            ...
            return ExecutionResult(
                success=True, action_type="list_meetings", data={"meetings": meetings}, response_template=template
            )
        except Exception as e:
