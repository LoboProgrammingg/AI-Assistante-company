...
def verify_email(data: VerifyEmailRequest, db: Session = Depends(get_db)):
    ...
    try:
        ...
        return VerifyEmailResponse(message="Email verificado com sucesso! Você já pode fazer login.", verified=True)
...
def resend_verification_code(data: ResendCodeRequest, db: Session = Depends(get_db)):
    ...
    try:
        ...
        return ResendCodeResponse(message="Código reenviado com sucesso! Verifique seu email.")
...
async def reset_password(request: Request, data: ResetPasswordRequest, db: Session = Depends(get_db)):
    ...
    try:
        ...
        return ResetPasswordResponse(message="Senha redefinida com sucesso! Você já pode fazer login.")
...
def change_password(
    ...
    try:
        auth_service.change_password(
            user_id=current_user.id, current_password=data.current_password, new_password=data.new_password
        )
