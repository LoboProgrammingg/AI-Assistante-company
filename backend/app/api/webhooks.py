    ...
    try:
        ...
        if next_action == "create_finance" and entities.get("finance"):
            try:
                ...
                finance_service.create_from_entities(user_id=user.id, entities=entities["finance"])
            ...
            try:
                ...
                for finance_data in entities["finances"]:
                    finance_service.create_from_entities(user_id=user.id, entities=finance_data)
                    count += 1
            ...
            try:
                ...
                reminder_service.create_from_entities(user_id=user.id, entities=entities["reminder"])
            ...
            try:
                ...
                meeting_service.create_from_entities(user_id=user.id, entities=entities["meeting"])
