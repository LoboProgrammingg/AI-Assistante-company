...
def convert_to_user_timezone(dt: datetime, user_timezone: str = "America/Sao_Paulo") -> datetime:
    """
...
def convert_to_utc(dt: datetime, user_timezone: str = "America/Sao_Paulo") -> datetime:
    """
...
def format_time_for_user(dt: datetime, user_timezone: str = "America/Sao_Paulo", format_str: str = "%H:%M") -> str:
    """
...
def format_date_for_user(dt: datetime, user_timezone: str = "America/Sao_Paulo", format_str: str = "%d/%m/%Y") -> str:
    """
...
def parse_natural_datetime(
    text: str, user_timezone: str = "America/Sao_Paulo", reference_time: Optional[datetime] = None
) -> Optional[datetime]:
    """
