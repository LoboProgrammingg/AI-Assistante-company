...
class WhatsAppService:
    ...
    def send_message(self, to_number: str, message: str, media_url: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            message_params = {"from_": self.from_number, "to": to_whatsapp, "body": message}
    ...
    async def download_audio(self, media_url: str, save_path: Path) -> Optional[Path]:
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                response = await client.get(media_url, auth=(self.client.username, self.client.password))
    ...
    def send_template_message(self, to_number: str, template_name: str, variables: list) -> Dict:
        ...
        try:
            ...
            message = self.client.messages.create(
                from_=self.from_number, to=to_whatsapp, content_sid=content_sid, content_variables=variables
            )
